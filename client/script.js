...
// CODE HERE
const changeColor =() => {
    sayHelloButton.classList.add('newcolor')
}
...
// CODE HERE
const removeColor =() => {
    sayHelloButton.classList.remove('newcolor')
}
...
const repeatMyParam = () => {
    ...
    axios.get('http://localhost:3000/repeat/im-making-a-param').then(res =>{
...
// CODE HERE
const queryReq = ()=> {
    axios.get('http://localhost:3000/query-test/?mynewquery=heyy!').then(res => {
        console.log(res.data)
    }).catch(err => console.log(err))
}
